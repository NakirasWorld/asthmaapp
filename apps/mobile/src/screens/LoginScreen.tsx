    ...
    <SafeAreaView style={[utils.flex1, utils.bgWhite]} edges={['top']}>
      ...
      >
        ...
        >
          ...
          <View style={[{ width: '100%', maxWidth: 400, alignSelf: 'center' }]}>
            ...
            <View style={[
              ...
              utils.py4,
              utils.mb6,
              { borderBottomWidth: 1, borderBottomColor: colors.gray200, marginBottom: 30 }
            ]}>
              <Ionicons name="person-outline" size={20} color={colors.gray400} style={[utils.mr4, { width: 20 }]} />
              <TextInput
            ...
            <View style={[
              ...
              <Ionicons name="globe-outline" size={20} color={colors.gray400} style={[utils.mr4, { width: 20 }]} />
              <TextInput
                style={[utils.flex1, utils.textBase, utils.textGray800]}
                placeholder="Region"
                placeholderTextColor={colors.gray400}
            ...
            {/* Forgot Links */}
            <View style={[utils.flexRow, utils.justifyBetween, utils.mb6, { marginBottom: 30 }]}>
              <TouchableOpacity style={utils.flex1}>
                <Text style={[utils.textGray500, utils.textSm, { textAlign: 'center' }]}>
                  Forget password?
                </Text>
              </TouchableOpacity>
              <TouchableOpacity style={utils.flex1}>
            ...
            <TouchableOpacity style={[
              ...
              <Text style={[utils.textPrimary, utils.textBase, utils.fontMedium]}>
        ...
        <View style={[utils.px8, utils.py5, utils.bgWhite, { paddingTop: 10 }]}>
          ...
          >
            <Text style={[utils.textPrimary, utils.textBase, utils.fontSemibold]}>
              Create Account
            </Text>
          </TouchableOpacity>
        </View>
