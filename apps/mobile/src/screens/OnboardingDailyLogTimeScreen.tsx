...
const OnboardingDailyLogTimeScreen: React.FC<
  OnboardingDailyLogTimeScreenProps
> = ({ onNext, onBack }) => {
        ...
        >
          ...
          >
            ...
            <View style={utils.flex1}>
              ...
              >
                By logging daily symptoms, you'll be able to better understand
                how daily patterns affect your child's asthma and overall
                wellbeing.
              </Text>
              ...
              >
                <Text
                  style={[utils.textLg, utils.textGray800, utils.fontMedium]}
                >
              ...
              {Platform.OS === "ios" && showTimePicker && (
                <View style={[utils.flexRow, utils.justifyBetween, utils.mb6]}>
                  ...
                  >
                    <Text style={[utils.textBase, utils.textGray600]}>
                      Cancel
                    </Text>
                  </TouchableOpacity>
                  <TouchableOpacity
