...
const OnboardingMedicationTimeScreen: React.FC<
  OnboardingMedicationTimeScreenProps
> = ({ onNext, onBack }) => {
        ...
        >
          ...
          >
            ...
            <View style={utils.flex1}>
              ...
              >
                Reminders help you ensure your child takes their asthma
                medication consistently, preventing symptoms and flare-ups.
              </Text>
